      ...
      >
        <template #tableTitle>
          <n-space>
            ...
            <n-button type="info" @click="addBpBizPthAcctInfoForm">
              <template #icon>
                <n-icon>
                  <PlusOutlined/>
                </n-icon>
            ...
            <n-button :disabled="isDisabledEdit" type="success" @click="addBpBizPthAcctInfoDetail">
              <template #icon>
                <n-icon>
                  <ReadOutlined/>
                </n-icon>
...
import {getTableList} from '@/api/receipt/receipt';
import {columns} from './columns';
import {DeleteOutlined, EditOutlined, PlusOutlined,ReadOutlined} from '@vicons/antd';
