...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const TabsMenuOptions = computed(() => {
        ...
        return [
          ...
          },
          {
            label: '关闭左侧',
            key: '5',
            disabled: isLeftLast(route) || isDisabled,
            icon: renderIcon(DoubleLeftOutlined),
          },
          {
            label: '关闭右侧',
            key: '6',
            disabled: isRightLast(route) || isDisabled,
      ...
      const isLeftLast = (route) => {
        return tabsViewStore.isLeftLast(route);
      };
      const isRightLast = (route) => {
        return tabsViewStore.isRightLast(route);
      };
      // 关闭右侧
